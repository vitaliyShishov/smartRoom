...
class ControllerCommonMenu extends Controller
{
    ...
    public function index()
    {
        ...
        $data['text_product_parameters'] = $this->language->get('text_product_parameters');
        ...
        $data['text_image_optimization']   = $this->language->get('text_image_optimization');
        $data['text_import_tool']   = $this->language->get('text_import_tool');
        ...
        $data['look'] = $this->url->link('catalog/look', 'token=' . $this->session->data['token'], 'SSL');
        $data['product_parameters'] = $this->url->link('catalog/product_parameter', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['import_tool'] = $this->url->link('tool/import_tool', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['image_optimization'] = $this->url->link('tool/image_optimization', 'token=' . $this->session->data['token'], 'SSL');
