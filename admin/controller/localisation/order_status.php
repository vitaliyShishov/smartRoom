...
/**
 * Класс контроллера для работы со статусами заказов
 *
 * PHP version 5.3
 *
 */
class ControllerLocalisationOrderStatus extends Controller
{
    ...
    /**
     * Метод для вывода списка статусов заказа
     */
    ...
    /**
     * Метод для редактирования статуса
     */
    ...
    /**
     * Метод для вывода формы редактирования/создания статуса
     */
    ...
    /**
     * Метод для проверки формы на корректность данных
     * 
     * @return array
     */
    ...
    /**
     * Метод для проверки прав и корректности выбраных данных для удаления
     * 
     * @return array
     */
