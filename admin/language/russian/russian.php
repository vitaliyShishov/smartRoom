...
$_['column_products']               = 'Обновленные товары';
$_['text_import']                   = 'Импорт ';
$_['text_list']                     = 'Список';
$_['text_import_heading']           = 'Импорт товаров';
$_['text_choose_file']              = 'Выберите файл';
$_['text_import_start']             = 'Запустить импорт';
...
$_['button_parameter_value_add']    = 'Добавить';
...
$_['tab_content_settings']          = 'Контентные настройки';
$_['tab_complect']                  = 'Комплекты';
$_['tab_api']                       = 'API и соц.сети';
$_['tab_to_category']               = 'Связь с категориями';
$_['tab_meta_settings']             = 'Мета данные';
$_['tab_content']                   = 'Информационный контент';
$_['tab_seo']                       = 'Seo';
$_['tab_payment_delivery']          = 'Оплата и доставка';
$_['tab_dilers']                    = 'Дилеры';
