        ...
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <button
                    ...
                    onclick="confirm('<?php echo $textConfirm; ?>') ? $('#form-information').submit() : false;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <?php if ($sort == 'id.title') { ?>
                                            <a href="<?php echo $sortTitle; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_title; ?></a>
                                        <?php } else { ?>
                                            <a href="<?php echo $sortTitle; ?>"><?php echo $column_title; ?></a>
                                        <?php } ?>
                                    </td>
                                    <td class="text-right">
                                        <?php if ($sort == 'i.sort_order') { ?>
                                            <a href="<?php echo $sortSortOrder; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_sort_order; ?></a>
                                        <?php } else { ?>
                                            <a href="<?php echo $sortSortOrder; ?>"><?php echo $column_sort_order; ?></a>
                                        <?php } ?>
                                    </td>
                                ...
                                <?php if ($informations) { ?>
                                    <?php foreach ($informations as $information) { ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo $information['edit']; ?>"
