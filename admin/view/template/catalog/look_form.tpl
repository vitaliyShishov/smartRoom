            ...
            <div class="tab-content">
                <div class="table-responsive">
                    <table id="images" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                        <?php $image_row = 0; ?>
                        <?php foreach ($look_images as $key => $image) { ?>
                            <tr id="image_row_<?php echo $image_row; ?>">
                                <td class="text-left">
                                    ...
                                    <input type="hidden"
                                           name="look_images[<?php echo $image_row; ?>][image]"
                                           value="<?php echo $image['image']; ?>"
                                           id="input-image<?php echo $image_row; ?>" />
                                </td>
                                <td class="text-center">
                                    <div class="col-sm-12">
                                        <select name="look_images[<?php echo $image_row; ?>][is_full]"
                                                   class="form-control">
                                ...
                                <td class="text-right">
                                    <input type="text"
                                           name="look_images[<?php echo $image_row; ?>][sort_order]"
...
<script type="text/javascript"><!--
        ...
        function addImage() {
            ...
            html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="look_images[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
            html += '<td class="text-center"> ';
            html += '<div class="col-sm-12">';
            html += '<select name="look_images[' + image_row + '][is_full]" class="form-control"> ';
            html += '<option value="1"><?php echo $text_image_type_full; ?></option>';
            html += '<option value="0"><?php echo $text_image_type_half; ?></option>';
            html += '</select>';
            html += '</div>';
            html += '  <td class="text-right"><input type="text" name="look_images[' + image_row + '][sort_order]" value="" placeholder="<?php echo $text_sort_order; ?>" class="form-control" /></td>';
            html += '</td>';
