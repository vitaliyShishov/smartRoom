          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <input type="text" name="filter_category" value="<?php echo $filter_category; ?>" placeholder="<?php echo $entry_category_filter; ?>" id="input-category" class="form-control" />
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-product-kod"><?php echo $entry_product_kod; ?></label>
                <input type="text" name="filter_product_kod" value="<?php echo $filter_product_kod; ?>" placeholder="<?php echo $entry_product_kod; ?>" id="input-product-kod" class="form-control" />
              </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right">
                      <?php if ($sort == 'p.price') { ?>
                          <a href="<?php echo $sort_price; ?>" class="<?php echo strtolower($order); ?>">
...
$('#button-filter').on('click', function() {
	...
	var filter_product_kod = $('input[name=\'filter_product_kod\']').val();

	if (filter_product_kod) {
		url += '&filter_product_kod=' + encodeURIComponent(filter_product_kod);
	}
